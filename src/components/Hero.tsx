...
const Hero = () => {
  return (
    <section id="home" className="relative bg-gradient-to-r from-brand-blue to-brand-magenta text-white py-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <h1 className="text-5xl md:text-6xl font-bold leading-tight">
              Tus Ideas
              <span className="block text-brand-yellow">Impresas con Calidad</span>
            </h1>
          ...
          <div className="relative">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 text-center">
              <img 
                src="/images/banner reactor.jpg" 
                alt="Servicios de Impresos Reactor - Diseño Gráfico, Imprenta, Soporte Técnico e Internet" 
